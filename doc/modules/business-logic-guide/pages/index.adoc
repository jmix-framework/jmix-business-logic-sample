...
[source,xml,indent=0]
----
include::example$/{sample-project}/main/resources/io/jmix/petclinic/view/pet/pet/pet-list-view.xml[tags=calculate-discount-action]
----
...
----
include::example$/{sample-project}/main/java/io/jmix/petclinic/view/pet/pet/PetListView.java[tags=calculate-discount]
----
...
[source,java,indent=0]
----
include::example$/{sample-project}/main/java/io/jmix/petclinic/view/pet/pet/contact/PetContactFetcher.java[tags=fetch-contact-logic]
----
...
[source,java,indent=0]
----
include::example$/{sample-project}/main/java/io/jmix/petclinic/view/pet/pet/PetDetailView.java[tags=fetch-contact]
----
...
[source,java,indent=0]
----
include::example$/{sample-project}/main/java/io/jmix/petclinic/service/DiseaseWarningMailingService.java[tags=disease-warning-mailing]
----
...
[source,java,indent=0]
----
include::example$/{sample-project}/main/java/io/jmix/petclinic/view/pet/pet/CreateDiseaseWarningMailing.java[tags=disease-warning-service-usage]
----
